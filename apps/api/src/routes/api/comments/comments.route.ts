...
commentsRouter.post('/', requireApiAuth, async (req: AuthenticatedRequest, res) => {
...
commentsRouter.patch('/:id', requireApiAuth, async (req: AuthenticatedRequest, res) => {
...
commentsRouter.delete('/:id', requireApiAuth, async (req: AuthenticatedRequest, res) => {
  try {
