        ...
        <div className="space-y-2 text-center">
          ...
          {isDeniedOrExpired ? (
            <p className="text-muted-foreground text-sm">
              ...
              allowlist entry, or send a message via Contact.
            </p>
          ) : (
            <p className="text-muted-foreground text-sm">
              Your email isn&apos;t approved for this workspace yet. Ask an
              admin to grant access, or send a message via Contact.
            </p>
          )}
        </div>
