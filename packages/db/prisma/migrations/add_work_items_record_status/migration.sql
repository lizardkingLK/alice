-- AlterTable: lifecycle archive flag on work_items (orthogonal to workflow status).

ALTER TABLE "work_items"
  ADD COLUMN "record_status" "RecordStatus" NOT NULL DEFAULT 'active';

CREATE INDEX "work_items_record_status_idx"
  ON "work_items" ("record_status");

CREATE INDEX "work_items_project_id_record_status_idx"
  ON "work_items" ("project_id", "record_status");
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT EXECUTE ON ROUTINES TO postgres, anon, authenticated, service_role;
