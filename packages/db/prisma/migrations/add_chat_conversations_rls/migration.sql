...
-- Create policy to allow authenticated users to insert their own conversations
...
-- Create policy to allow authenticated users to select their own conversations
...
-- Create policy to allow authenticated users to update their own conversations
...
-- Create policy to allow authenticated users to delete their own conversations
