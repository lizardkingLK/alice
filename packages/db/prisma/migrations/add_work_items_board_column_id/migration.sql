-- AlterTable
ALTER TABLE "access_requests" ALTER COLUMN "updated_at" DROP DEFAULT;

-- AlterTable
ALTER TABLE "chat_attachments" ALTER COLUMN "updated_at" DROP DEFAULT;

-- AlterTable
ALTER TABLE "work_items" ADD COLUMN     "board_column_id" TEXT;
