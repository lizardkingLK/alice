...
1. **`list_sprints`**:
   ...
   - Provides context when users ask: *"What sprints are currently active?"* or *"List all sprints for project Alpha."*
2. **`create_sprint`**:
   - Allows users to create sprints conversatonally:
     > *"Create Sprint 12 for Project Mobile from October 1 to October 15 with goal 'Launch Auth flow'"*
