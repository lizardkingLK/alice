...
| Integrations | [features/integrations/](./features/integrations/) ([SETTINGS_INTEGRATIONS.md](./features/integrations/SETTINGS_INTEGRATIONS.md)) — workspace AI/tools (admin Settings tab) (**Plan**)                                                    |
