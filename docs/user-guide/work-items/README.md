...
| Filters (**Shift+F**) | Filter icon → project, sprint, type, assignee, and more. Sprint options are grouped by project (expanded); search hides non-matches. On Project / Sprint, **Set as default** saves workspace defaults on Okay.                              |
