...
- **Identical project listing**: Asking Alice _"show all projects"_ or _"list down all the projects"_ outputs the identical subset of projects displayed on your Project Registry page.
...
When you ask Alice to list or show your projects (e.g., _"show all projects"_, _"list all projects"_, _"list down all the projects"_):
