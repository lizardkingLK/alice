...
| **Backend API Service**    | `apps/api/src/`<br>`apps/api/src/routes/`<br>`apps/api/src/controllers/`                                                 | Express REST API server providing backend endpoints, Zod input validation, in-app notification writes, and Supabase DB calls.                                   | `apps/api` (Vitest configured)                                                                             | `apps/web/cypress/e2e/sprints.cy.ts`<br>`apps/web/cypress/e2e/home.cy.ts` |
